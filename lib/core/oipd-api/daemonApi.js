...
class DaemonApi {
  ...
  async getOip5Mapping(tmplIdentifiers) {
    ...
    if (res && res.data) {
      ...
      return {
        success: false,
        error: `Failed to get data back from axios request trying to get oip5 mappings: ${err}`
      };
    }
  }
  /**
