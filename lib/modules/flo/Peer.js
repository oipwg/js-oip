...
class Peer {
  ...
  handleGetData(getDataPacket) {
    ...
    console.log("[RPC Wallet] Relayed ".concat(txsRelayed, "/").concat(getDataPacket.items.length, " requested transactions to ").concat(this.settings.ip, " (last txid ").concat(lastHash, ")"));
  }
